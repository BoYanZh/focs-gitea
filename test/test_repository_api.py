...
import focs_gitea
from focs_gitea.api.repository_api import RepositoryApi  # noqa: E501
...
class TestRepositoryApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = focs_gitea.api.repository_api.RepositoryApi()  # noqa: E501
    ...
    def test_create_repo_variable(self):
    ...
    def test_get_repo_variable(self):
    ...
    def test_get_repo_variables_list(self):
    ...
    def test_repo_compare_diff(self):
    ...
    def test_repo_get_commit_pull_request(self):
    ...
    def test_repo_get_pull_request_by_base_head(self):
    ...
    def test_repo_get_runner_registration_token(self):
    ...
    def test_repo_list_actions_secrets(self):
    ...
    def test_update_repo_secret(self):
    ...
    def test_update_repo_variable(self):
