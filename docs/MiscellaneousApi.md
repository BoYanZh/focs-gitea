...
api_instance = focs_gitea.MiscellaneousApi(focs_gitea.ApiClient(configuration))
...
# create an instance of the API class
api_instance = focs_gitea.MiscellaneousApi(focs_gitea.ApiClient(configuration))
body = focs_gitea.MarkdownOption() # MarkdownOption |  (optional)
...
# create an instance of the API class
api_instance = focs_gitea.MiscellaneousApi(focs_gitea.ApiClient(configuration))
body = focs_gitea.MarkupOption() # MarkupOption |  (optional)
