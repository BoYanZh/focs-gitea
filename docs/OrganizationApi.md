...
api_instance = focs_gitea.OrganizationApi(focs_gitea.ApiClient(configuration))
...
api_instance = focs_gitea.OrganizationApi(focs_gitea.ApiClient(configuration))
org = 'org_example' # str | name of the organization
body = focs_gitea.CreateTeamOption() # CreateTeamOption |  (optional)
...
body = focs_gitea.EditOrgOption() # EditOrgOption | 
...
body = focs_gitea.EditTeamOption() # EditTeamOption |  (optional)
...
# **team_search**
> object team_search(org, q=q, include_desc=include_desc, page=page, limit=limit)
